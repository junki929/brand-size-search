...
class TopController < ApplicationController
  def search
    select_tops = params[:tops_sizes].presence
    ...
    select_shirts = params[:shirts_sizes].presence
    ...
    select_bottoms = params[:bottoms_sizes].presence
    ...
    select_shoes = params[:shoes_sizes].presence
